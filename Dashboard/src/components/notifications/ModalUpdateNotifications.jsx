...
export default function ModalUpdateNotification({
  titleModal,
  notificationContent,
  titleButton,
  iconButton,
  ...
  const [notificationsContent, setNotificationsContent] = useState(notificationContent)
  ...
  async function UpdateNotification(idNotifications, field, value) {
    try {
      const response = await api.patch(
        `/notifications/notifications/${idNotifications}/${field}`,
        {
          [field]: value,
        },
        {
  ...
  const handleConfirm = (event) => {
    ...
    if (selectField) {
      UpdateNotification(parseInt(notificationsContent[0].idNotifications), selectField, notifications[selectField])
    } else {
                ...
                <div className="grid gap-4 mb-4 grid-cols-2">
                  <div className="col-span-2">
                    ...
                    >
                      ...
                      <option value="message">Mensagem de Notificação</option>
                    </select>
                  </div>
                  ...
                  {selectField === "message" && (
                    <div className="col-span-2">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          setNotifications({ ...notifications, message: e.target.value })
                        }
