...
export default function ModalUpdateEvent({
    ...
    const [calendarEventContent, setCalendarEventContent] = useState(calendarEventsContent)
    ...
    const handleSubmit = (e) => {
        ...
        if (selectField) {
            if (selectField === 'start' || selectField === 'end') {
                UpdateCalendarEvents(calendarEventContent.idCalendarEvents, selectField, formatTimeForSQL(calendarEvents[selectField]))

            } else {
                UpdateCalendarEvents(calendarEventContent.idCalendarEvents, selectField, calendarEvents[selectField])
            }
        } else {
                                        ...
                                        {selectField === "start" && (
                                            <div>
                                                ...
                                                <Calendar
                                                    ...
                                                    timeOnly
                                                    value={calendarEvents[selectField]}
                                                    onChange={(e) => setCalendarEvents({ ...calendarEvents, [selectField]: e.value })}
                                                />
                                            </div>
                                        )}
