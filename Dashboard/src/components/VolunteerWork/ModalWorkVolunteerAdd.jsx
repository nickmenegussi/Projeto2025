...
export default function ModalWorkVolunteerAdd({
  titleModal,
  titleButton,
  iconButton,
  otherStyle,
    ...
    try {
      const response = await api.post(
        "/VolunteerWork/work/create",
        {
          ...
          timeVolunteerWork: formateTimeForSql(timeVolunteerWork),
          work_description,
        },
        {
          headers: {
                ...
                <div className="grid gap-4 mb-4 grid-cols-2">
                  ...
                  <div className="col-span-2">
                    ...
                    <Calendar
                      ...
                      onChange={(e) =>
                        setCalendarEvents({ ...volunteerWork, timeVolunteerWork: e.value })
                      }
                      className="border border-gray-300 text-gray-900 rounded-lg p-2.5 w-full"
                    />
                  </div>
