...
export function AuthProvider({children}){
  ...
  async function login(email, password){
      ...
      if(response.data.error){
          ...
          navigate("/auth/emailOtp") // Redireciona após envio do OTP
      }
  }
  ...
  return (
      <AuthCtx.Provider value={{user, setUser, login, logout, otpEmail ,OtpSendEmail, otpDigits, OtpVerification, loading}}>
          {children}
      </AuthCtx.Provider>
  )
}