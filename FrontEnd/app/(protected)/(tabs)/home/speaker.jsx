  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={{ padding: 10 }}>
        ...
        <CustomNavagation sendData={false} trendingItems={[{name: 'Palestrante', path: '/home/speaker',}, {name: 'Propósito', path: '/home/lecturesObjective'} , {name: 'Público alvo', path: '/home/targetPublicLectures'}]}/>
