      ...
      <ScrollView style={styles.scrollContainer}>
        <View>
          ...
          <View style={styles.ContainerContent}>
            <Text style={styles.textContentContainer}>
            ...
            {lecture.length > 0 ? (
              <View style={styles.ContainerIcons}>
                <View style={styles.contentIcons}>
                  ...
                  <Text style={styles.SmallTextContentIcons}>
                    R. Coração de Maria, 341 - Centro, Esteio - RS,
                  </Text>
                </View>
                <View style={styles.contentIcons}>
                  <CalendarIcon size={25} color={"white"} />
                  <Text style={styles.TextContentIcons}>
                    Data:{" "}
                    {ConvertDateTimeTo(lecture[0].dateLecture) ? (
                      ConvertDateTimeTo(lecture[0].dateLecture)
                    ) : (
                      <Text>Nenhum Conteudo encontrado</Text>
                    )}
                  </Text>
                </View>
                <View style={styles.contentIcons}>
                  ...
                  <Text style={styles.TextContentIcons}>
                    Hora: {lecture[0].timeLecture}
                  </Text>
                </View>
                <View style={styles.line}></View>
                <Text style={styles.textChapter}>
                  Capítulo I: {lecture[0].nameLecture}
                </Text>
              </View>
            ) : (
            ...
            <View style={styles.line}></View>
            <VideoUrl
              videoUrl={lecture[0].link_url ? lecture[0].link_url : ""}
            />
